	...
	<form method="post">
		<table border="0">
			...
			<tr>
				...
				<td><input type="checkbox" name="cat" value="Kehadiran >= 70 %">Kehadiran >= 70 %</td>
			</tr>
			<tr>
				<td><input type="checkbox" name="cat1" value="Interaktif dikelas">Interaktif dikelas</td>
			</tr>
			<tr>
				<td><input type="checkbox" name="cat2" value="Tidak terlambat mengumpulkan tugas">Tidak terlambat mengumpulkan tugas</td>
			</tr>
			<tr>
				<td></td>
